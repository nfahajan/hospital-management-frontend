...
export function DateTimePicker({
  ...
  useEffect(() => {
    if (slotsResponse?.data) {
      ...
      if (Array.isArray(slotsResponse.data)) {
        ...
        // Backend returns: { doctor: {...}, date: "...", availableSlots: [...] }
        if (
  ...
  const handleTimeSelect = (timeSlot: string) => {
    console.log("DateTimePicker: handleTimeSelect called with:", timeSlot);
    if (!timeSlot || typeof timeSlot !== "string") {
      console.error("DateTimePicker: Invalid timeSlot:", timeSlot);
      return;
    }
  ...
  // Debug logging
  console.log("DateTimePicker: timeSlots:", timeSlots);
  console.log("DateTimePicker: selectedDate:", selectedDate);
  console.log("DateTimePicker: availableSlots:", availableSlots);
